...
const Favourites = () => {
  ...
  const { setFavorite } = useContext(DataContext);
	...
	return (
		<>
			<h3 style={{ marginBottom: '50px', marginTop: '15px' }}>Course Favorite</h3>
			{/*videos*/}
			{Favorites.length > 0 ? (
				...
				No courses in the Favorite, go to <a style={{ color: 'blue' }} href="/dashboard">Courses</a> to add some favorites.
				</p>
			)}
